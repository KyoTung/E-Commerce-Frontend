...
const product = {
  ...
  description: "<p>iPhone 15 là sản phẩm mới nhất của Apple với thiết kế hiện đại, hiệu năng mạnh mẽ và camera cải tiến. Sản phẩm chính hãng VN/A, bảo hành 12 tháng.</p><p>Màn hình Super Retina XDR 6.7 inch, công nghệ Dynamic Island độc đáo. Chip A17 Pro cho hiệu năng vượt trội, chơi game mượt mà.</p>"
};
...
const ProductDetail = () => {
  ...
  const productImages = [
    ...
    { id: 2, image_url: "https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone-15-plus_5__1.png" },
    { id: 3, image_url: "https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone-15-plus_3__1.png" },
    { id: 4, image_url: "https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone-15-plus_4__1.png" },
  ];
    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-6">
          ...
          <div>
           ...
           <div>
            ...
            <div className='flex'>
                <a className='px-7 py-4 border rounded-md'>Đen</a>
                 <a className='px-7 py-4 border rounded-md ml-5'>Trắng</a>
                 <a className='px-7 py-4 border rounded-md ml-5'>Xanh dương</a>
                 <a className='px-7 py-4 border rounded-md ml-5'>Hồng</a>
                 <a className='px-7 py-4 border rounded-md ml-5'>Ngọc Trai</a>
            </div>
          </div>
      ...
      <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="rounded-lg bg-white p-6 shadow-md">
          <h2 className="mb-4 text-xl font-bold text-gray-900">Thông số kỹ thuật</h2>
          <div className="space-y-3">
            ...
            <div className="flex border-b pb-2">
              <span className="w-1/3 font-medium text-gray-600">Bộ nhớ trong:</span>
            ...
            <div className="flex">
              <span className="w-1/3 font-medium text-gray-600">Hệ điều hành:</span>
        ...
        {/* Product Description */}
        <div className="rounded-lg bg-white p-6 shadow-md">
          <h2 className="mb-4 text-xl font-bold text-gray-900">Mô tả sản phẩm</h2>
