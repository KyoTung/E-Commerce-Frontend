        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li className="flex justify-between">
                ...
                <a
                  href="tel:18002097"
                  className="font-bold text-gray-800 hover:text-[#d70018]"
                >
                  1800.2097
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              ...
              <a
                href="#"
                className="h-8 w-8 flex items-center justify-center rounded bg-black text-white hover:opacity-90"
              >
                <SiTiktok />
              </a>
              <a
                href="#"
                className="h-8 w-8 flex items-center justify-center rounded bg-[#E1306C] text-white hover:opacity-90"
              >
                <FaInstagram />
              </a>
              <a
                href="#"
                className="h-8 w-8 flex items-center justify-center rounded bg-[#0068FF] text-white hover:opacity-90"
              >
                <SiZalo size={20} />
              </a>
            </div>
